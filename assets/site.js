...
/* ==============================
   UPYA LEADERSHIP SLIDESHOW
   ============================== */

const leadershipSlides = [
  ...document.querySelectorAll(".leadership-slide")
];

const leadershipDots = [
  ...document.querySelectorAll(
    ".leadership-slide-dots button"
  )
];

let activeLeadershipSlide = 0;


function showLeadershipSlide(index) {

  if (!leadershipSlides.length) return;

  activeLeadershipSlide =
    (index + leadershipSlides.length) %
    leadershipSlides.length;

  leadershipSlides.forEach(
    (slide, position) => {

      slide.classList.toggle(
        "active",
        position === activeLeadershipSlide
      );

    }
  );

  leadershipDots.forEach(
    (dot, position) => {
...
if (leadershipSlides.length > 1) {

  window.setInterval(
    () => {
      showLeadershipSlide(
        activeLeadershipSlide + 1
      );
    },
    5000
  );
...
const leaderProfiles = {
  ...
  hillary: {
    ...
    position: "Chairperson",
    responsibility:
      "Strategic leadership, organizational direction, representation and community engagement.",
    philosophy:
      "Leadership should be rooted in service, responsibility and the commitment to create opportunities for others.",
    contribution:
      "Provides strategic direction and supports UPYA's mission of empowering, equipping, mentoring and nurturing tomorrow's world."
  },
  ...
  brian: {
    ...
    position: "Secretary",
    responsibility:
      "Organizational coordination, documentation, communication and administrative support.",
    philosophy:
      "Effective leadership requires clear communication, organization and teamwork.",
    contribution:
      "Supports coordination of UPYA activities, records and communication to strengthen organizational effectiveness."
  },
  ...
  dennis: {
    ...
    position: "Treasurer",
    responsibility:
      "Financial accountability, resource management and financial oversight.",
    philosophy:
      "Trust grows when resources are handled responsibly and transparently.",
    contribution:
      "Supports responsible management of UPYA resources and promotes accountability in organizational activities."
  }
...
function openLeaderProfile(leaderKey) {

  const leader =
    leaderProfiles[leaderKey];
  ...
  modalDetails.innerHTML = `
    ...
    <div class="profile-detail">
      <strong>Contributions to UPYA</strong>
      <p>${leader.contribution}</p>
    </div>
  `;
